! Used Bitmap: 'viaCpwBpf_top.bmp' & 'viaCpwBpf_bottom.bmp'
! epsR: 10.2, freq: 2000000000.0, tanD: 0.005, substrateDepth: 0.0006
! Made at Tue Jul 26 02:42:32 +0900 2011
...
module setup
  ...
  ! File name
  character*128, parameter :: filename='test_hole'
  ! FDTD setup
  ...
  real*8, parameter :: freqS_pat = 1.0d9
  real*8, parameter :: freqE_pat = 5.0d9
  integer, parameter :: freqPoint_pat = 11
  integer, parameter :: XS_pat = 30, YS_pat = 30, ZS_pat = 30
  integer, parameter :: XE_pat = 180, YE_pat = 180, ZE_pat = 180
  integer, parameter :: patternFlag = 1
  integer, parameter :: efficiencyFlag = 1
...
contains
  ...
  subroutine setmodel !------------------------------------------------------------
   ...
   !-------------------------------------!
    ...
    call setbox(3, 60, 60, 47, 240, 240, 53)
    call setplane(4, 60, 60, 47,   240, 240, 47)
    call setplane(4, 60, 60, 53,   240, 240, 53)


! Top pattern ----
    call setplane(2, 60, 60, 53,   240, 61, 53)
    call setplane(2, 60, 61, 53,   240, 62, 53)
    call setplane(2, 60, 62, 53,   240, 63, 53)
    call setplane(2, 60, 63, 53,   240, 64, 53)
    call setplane(2, 60, 64, 53,   240, 65, 53)
    call setplane(2, 60, 65, 53,   240, 66, 53)
    call setplane(2, 60, 66, 53,   240, 67, 53)
    call setplane(2, 60, 67, 53,   240, 68, 53)
    call setplane(2, 60, 68, 53,   240, 69, 53)
    call setplane(2, 60, 69, 53,   240, 70, 53)
    call setplane(2, 60, 70, 53,   240, 71, 53)
    call setplane(2, 60, 71, 53,   240, 72, 53)
    call setplane(2, 60, 72, 53,   240, 73, 53)
    call setplane(2, 60, 73, 53,   240, 74, 53)
    call setplane(2, 60, 74, 53,   240, 75, 53)
    call setplane(2, 60, 75, 53,   240, 76, 53)
    call setplane(2, 60, 76, 53,   240, 77, 53)
    call setplane(2, 60, 77, 53,   240, 78, 53)
    call setplane(2, 60, 78, 53,   240, 79, 53)
    call setplane(2, 60, 79, 53,   240, 80, 53)
    call setplane(2, 60, 80, 53,   240, 81, 53)
    call setplane(2, 60, 81, 53,   240, 82, 53)
    call setplane(2, 60, 82, 53,   240, 83, 53)
    call setplane(2, 60, 83, 53,   240, 84, 53)
    call setplane(2, 60, 84, 53,   240, 85, 53)
    call setplane(2, 60, 85, 53,   240, 86, 53)
    call setplane(2, 60, 86, 53,   240, 87, 53)
    call setplane(2, 60, 87, 53,   240, 88, 53)
    call setplane(2, 60, 88, 53,   240, 89, 53)
    call setplane(2, 60, 89, 53,   240, 90, 53)
    call setplane(2, 60, 90, 53,   240, 91, 53)
    call setplane(2, 60, 91, 53,   240, 92, 53)
    call setplane(2, 60, 92, 53,   240, 93, 53)
    call setplane(2, 60, 93, 53,   240, 94, 53)
    call setplane(2, 60, 94, 53,   240, 95, 53)
    call setplane(2, 60, 95, 53,   240, 96, 53)
    call setplane(2, 60, 96, 53,   240, 97, 53)
    call setplane(2, 60, 97, 53,   240, 98, 53)
    call setplane(2, 60, 98, 53,   240, 99, 53)
    call setplane(2, 60, 99, 53,   240, 100, 53)
    call setplane(2, 60, 100, 53,   240, 101, 53)
    call setplane(2, 60, 101, 53,   240, 102, 53)
    call setplane(2, 60, 102, 53,   240, 103, 53)
    call setplane(2, 60, 103, 53,   240, 104, 53)
    call setplane(2, 60, 104, 53,   240, 105, 53)
    call setplane(2, 60, 105, 53,   240, 106, 53)
    call setplane(2, 60, 106, 53,   240, 107, 53)
    call setplane(2, 60, 107, 53,   240, 108, 53)
    call setplane(2, 60, 108, 53,   240, 109, 53)
    call setplane(2, 60, 109, 53,   240, 110, 53)
    call setplane(2, 60, 110, 53,   240, 111, 53)
    call setplane(2, 60, 111, 53,   240, 112, 53)
    call setplane(2, 60, 112, 53,   240, 113, 53)
    call setplane(2, 60, 113, 53,   240, 114, 53)
    call setplane(2, 60, 114, 53,   240, 115, 53)
    call setplane(2, 60, 115, 53,   240, 116, 53)
    call setplane(2, 60, 116, 53,   240, 117, 53)
    call setplane(2, 60, 117, 53,   240, 118, 53)
    call setplane(2, 60, 118, 53,   240, 119, 53)
    call setplane(2, 60, 119, 53,   240, 120, 53)
    call setplane(2, 60, 120, 53,   240, 121, 53)
    call setplane(2, 60, 121, 53,   240, 122, 53)
    call setplane(2, 60, 122, 53,   240, 123, 53)
    call setplane(2, 60, 123, 53,   240, 124, 53)
    call setplane(2, 60, 124, 53,   240, 125, 53)
    call setplane(2, 60, 125, 53,   240, 126, 53)
    call setplane(2, 60, 126, 53,   240, 127, 53)
    call setplane(2, 60, 127, 53,   240, 128, 53)
    call setplane(2, 60, 128, 53,   240, 129, 53)
    call setplane(2, 60, 129, 53,   240, 130, 53)
    call setplane(2, 60, 130, 53,   240, 131, 53)
    call setplane(2, 60, 131, 53,   240, 132, 53)
    call setplane(2, 60, 132, 53,   240, 133, 53)
    call setplane(2, 60, 133, 53,   240, 134, 53)
    call setplane(2, 60, 134, 53,   240, 135, 53)
    call setplane(2, 60, 135, 53,   240, 136, 53)
    call setplane(2, 60, 136, 53,   240, 137, 53)
    call setplane(2, 60, 137, 53,   240, 138, 53)
    call setplane(2, 60, 138, 53,   240, 139, 53)
    call setplane(2, 60, 139, 53,   240, 140, 53)
    call setplane(2, 60, 142, 53,   240, 143, 53)
    call setplane(2, 60, 143, 53,   240, 144, 53)
    call setplane(2, 60, 144, 53,   240, 145, 53)
    call setplane(2, 60, 145, 53,   240, 146, 53)
    call setplane(2, 60, 146, 53,   240, 147, 53)
    call setplane(2, 60, 147, 53,   147, 148, 53)
    call setplane(2, 153, 147, 53,   240, 148, 53)
    call setplane(2, 60, 148, 53,   147, 149, 53)
    call setplane(2, 153, 148, 53,   240, 149, 53)
    call setplane(2, 60, 149, 53,   147, 150, 53)
    call setplane(2, 153, 149, 53,   240, 150, 53)
    call setplane(2, 60, 150, 53,   147, 151, 53)
    call setplane(2, 153, 150, 53,   240, 151, 53)
    call setplane(2, 60, 151, 53,   147, 152, 53)
    call setplane(2, 153, 151, 53,   240, 152, 53)
    call setplane(2, 60, 152, 53,   147, 153, 53)
    call setplane(2, 153, 152, 53,   240, 153, 53)
    call setplane(2, 60, 153, 53,   240, 154, 53)
    call setplane(2, 60, 154, 53,   240, 155, 53)
    call setplane(2, 60, 155, 53,   240, 156, 53)
    call setplane(2, 60, 156, 53,   240, 157, 53)
    call setplane(2, 60, 157, 53,   240, 158, 53)
    call setplane(2, 60, 160, 53,   240, 161, 53)
    call setplane(2, 60, 161, 53,   240, 162, 53)
    call setplane(2, 60, 162, 53,   240, 163, 53)
    call setplane(2, 60, 163, 53,   240, 164, 53)
    call setplane(2, 60, 164, 53,   240, 165, 53)
    call setplane(2, 60, 165, 53,   240, 166, 53)
    call setplane(2, 60, 166, 53,   240, 167, 53)
    call setplane(2, 60, 167, 53,   240, 168, 53)
    call setplane(2, 60, 168, 53,   240, 169, 53)
    call setplane(2, 60, 169, 53,   240, 170, 53)
    call setplane(2, 60, 170, 53,   240, 171, 53)
    call setplane(2, 60, 171, 53,   240, 172, 53)
    call setplane(2, 60, 172, 53,   240, 173, 53)
    call setplane(2, 60, 173, 53,   240, 174, 53)
    call setplane(2, 60, 174, 53,   240, 175, 53)
    call setplane(2, 60, 175, 53,   240, 176, 53)
    call setplane(2, 60, 176, 53,   240, 177, 53)
    call setplane(2, 60, 177, 53,   240, 178, 53)
    call setplane(2, 60, 178, 53,   240, 179, 53)
    call setplane(2, 60, 179, 53,   240, 180, 53)
    call setplane(2, 60, 180, 53,   240, 181, 53)
    call setplane(2, 60, 181, 53,   240, 182, 53)
    call setplane(2, 60, 182, 53,   240, 183, 53)
    call setplane(2, 60, 183, 53,   240, 184, 53)
    call setplane(2, 60, 184, 53,   240, 185, 53)
    call setplane(2, 60, 185, 53,   240, 186, 53)
    call setplane(2, 60, 186, 53,   240, 187, 53)
    call setplane(2, 60, 187, 53,   240, 188, 53)
    call setplane(2, 60, 188, 53,   240, 189, 53)
    call setplane(2, 60, 189, 53,   240, 190, 53)
    call setplane(2, 60, 190, 53,   240, 191, 53)
    call setplane(2, 60, 191, 53,   240, 192, 53)
    call setplane(2, 60, 192, 53,   240, 193, 53)
    call setplane(2, 60, 193, 53,   240, 194, 53)
    call setplane(2, 60, 194, 53,   240, 195, 53)
    call setplane(2, 60, 195, 53,   240, 196, 53)
    call setplane(2, 60, 196, 53,   240, 197, 53)
    call setplane(2, 60, 197, 53,   240, 198, 53)
    call setplane(2, 60, 198, 53,   240, 199, 53)
    call setplane(2, 60, 199, 53,   240, 200, 53)
    call setplane(2, 60, 200, 53,   240, 201, 53)
    call setplane(2, 60, 201, 53,   240, 202, 53)
    call setplane(2, 60, 202, 53,   240, 203, 53)
    call setplane(2, 60, 203, 53,   240, 204, 53)
    call setplane(2, 60, 204, 53,   240, 205, 53)
    call setplane(2, 60, 205, 53,   240, 206, 53)
    call setplane(2, 60, 206, 53,   240, 207, 53)
    call setplane(2, 60, 207, 53,   240, 208, 53)
    call setplane(2, 60, 208, 53,   240, 209, 53)
    call setplane(2, 60, 209, 53,   240, 210, 53)
    call setplane(2, 60, 210, 53,   240, 211, 53)
    call setplane(2, 60, 211, 53,   240, 212, 53)
    call setplane(2, 60, 212, 53,   240, 213, 53)
    call setplane(2, 60, 213, 53,   240, 214, 53)
    call setplane(2, 60, 214, 53,   240, 215, 53)
    call setplane(2, 60, 215, 53,   240, 216, 53)
    call setplane(2, 60, 216, 53,   240, 217, 53)
    call setplane(2, 60, 217, 53,   240, 218, 53)
    call setplane(2, 60, 218, 53,   240, 219, 53)
    call setplane(2, 60, 219, 53,   240, 220, 53)
    call setplane(2, 60, 220, 53,   240, 221, 53)
    call setplane(2, 60, 221, 53,   240, 222, 53)
    call setplane(2, 60, 222, 53,   240, 223, 53)
    call setplane(2, 60, 223, 53,   240, 224, 53)
    call setplane(2, 60, 224, 53,   240, 225, 53)
    call setplane(2, 60, 225, 53,   240, 226, 53)
    call setplane(2, 60, 226, 53,   240, 227, 53)
    call setplane(2, 60, 227, 53,   240, 228, 53)
    call setplane(2, 60, 228, 53,   240, 229, 53)
    call setplane(2, 60, 229, 53,   240, 230, 53)
    call setplane(2, 60, 230, 53,   240, 231, 53)
    call setplane(2, 60, 231, 53,   240, 232, 53)
    call setplane(2, 60, 232, 53,   240, 233, 53)
    call setplane(2, 60, 233, 53,   240, 234, 53)
    call setplane(2, 60, 234, 53,   240, 235, 53)
    call setplane(2, 60, 235, 53,   240, 236, 53)
    call setplane(2, 60, 236, 53,   240, 237, 53)
    call setplane(2, 60, 237, 53,   240, 238, 53)
    call setplane(2, 60, 238, 53,   240, 239, 53)
    call setplane(2, 60, 239, 53,   240, 240, 53)


! Bottom pattern ----
    call setplane(2, 140, 139, 47,   160, 140, 47)
    call setplane(2, 140, 140, 47,   160, 141, 47)
    call setplane(2, 140, 141, 47,   160, 142, 47)
    call setplane(2, 140, 142, 47,   160, 143, 47)
    call setplane(2, 140, 143, 47,   160, 144, 47)
    call setplane(2, 140, 144, 47,   160, 145, 47)
    call setplane(2, 140, 145, 47,   160, 146, 47)
    call setplane(2, 140, 146, 47,   160, 147, 47)
    call setplane(2, 140, 147, 47,   160, 148, 47)
    call setplane(2, 140, 148, 47,   160, 149, 47)
    call setplane(2, 140, 149, 47,   160, 150, 47)
    call setplane(2, 140, 150, 47,   160, 151, 47)
    call setplane(2, 140, 151, 47,   160, 152, 47)
    call setplane(2, 140, 152, 47,   160, 153, 47)
    call setplane(2, 140, 153, 47,   160, 154, 47)
    call setplane(2, 140, 154, 47,   160, 155, 47)
    call setplane(2, 140, 155, 47,   160, 156, 47)
    call setplane(2, 140, 156, 47,   160, 157, 47)
    call setplane(2, 140, 157, 47,   160, 158, 47)
    call setplane(2, 140, 158, 47,   160, 159, 47)


! Throgh hole ----
    call setbox(2, 147, 147, 47, 153, 148, 53)
    call setbox(2, 147, 148, 47, 153, 149, 53)
    call setbox(2, 147, 149, 47, 153, 150, 53)
    call setbox(2, 147, 150, 47, 153, 151, 53)
    call setbox(2, 147, 151, 47, 153, 152, 53)
    call setbox(2, 147, 152, 47, 153, 153, 53)


! Feed point ----
    call setfeed(1, 60, 140, 53,   60, 142, 53, 100.0d0, 1, 800.0d0 * dt, 1.0d0)
    call setfeed(2, 60, 160, 53,   60, 158, 53, 100.0d0, 1, 800.0d0 * dt, 1.0d0)
    call setfeed(3, 240, 140, 53,   240, 142, 53, 100.0d0, 1, 800.0d0 * dt, 0.0d0)
    call setfeed(4, 240, 160, 53,   240, 158, 53, 100.0d0, 1, 800.0d0 * dt, 0.0d0)
