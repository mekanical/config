! Used Bitmap: 'milliDipole15GHz_26_top.bmp' & 'milliDipole15GHz_26_bottom.bmp'
! epsR: 10.2, freq: 2000000000.0, tanD: 0.005, substrateDepth: 0.0006
! Made at Wed Jul 27 02:37:39 +0900 2011
...
module setup
  ...
  ! File name
  character*128, parameter :: filename='test_msl'
  ! FDTD setup
...
contains
  ...
  subroutine setmodel !------------------------------------------------------------
   ...
   !-------------------------------------!
    ...
    call setbox(3, 110, 110, 47, 190, 190, 53)
    call setplane(4, 110, 110, 47,   190, 190, 47)
    call setplane(4, 110, 110, 53,   190, 190, 53)


! Top pattern ----
    call setplane(2, 150, 122, 53,   154, 123, 53)
    call setplane(2, 150, 123, 53,   154, 124, 53)
    call setplane(2, 150, 124, 53,   154, 125, 53)
    call setplane(2, 150, 125, 53,   154, 126, 53)
    call setplane(2, 150, 126, 53,   154, 127, 53)
    call setplane(2, 150, 127, 53,   154, 128, 53)
    call setplane(2, 150, 128, 53,   154, 129, 53)
    call setplane(2, 150, 129, 53,   154, 130, 53)
    call setplane(2, 150, 130, 53,   154, 131, 53)
    call setplane(2, 150, 131, 53,   154, 132, 53)
    call setplane(2, 150, 132, 53,   154, 133, 53)
    call setplane(2, 150, 133, 53,   154, 134, 53)
    call setplane(2, 150, 134, 53,   154, 135, 53)
    call setplane(2, 150, 135, 53,   154, 136, 53)
    call setplane(2, 150, 136, 53,   154, 137, 53)
    call setplane(2, 150, 137, 53,   154, 138, 53)
    call setplane(2, 150, 138, 53,   154, 139, 53)
    call setplane(2, 150, 139, 53,   154, 140, 53)
    call setplane(2, 150, 140, 53,   154, 141, 53)
    call setplane(2, 150, 141, 53,   154, 142, 53)
    call setplane(2, 150, 142, 53,   154, 143, 53)
    call setplane(2, 150, 143, 53,   154, 144, 53)
    call setplane(2, 150, 144, 53,   154, 145, 53)
    call setplane(2, 150, 145, 53,   154, 146, 53)
    call setplane(2, 150, 146, 53,   154, 147, 53)
    call setplane(2, 150, 147, 53,   154, 148, 53)
    call setplane(2, 110, 148, 53,   111, 149, 53)
    call setplane(2, 111, 148, 53,   153, 149, 53)
    call setplane(2, 110, 149, 53,   111, 150, 53)
    call setplane(2, 111, 149, 53,   152, 150, 53)
    call setplane(2, 110, 150, 53,   111, 151, 53)
    call setplane(2, 111, 150, 53,   151, 151, 53)
    call setplane(2, 110, 151, 53,   111, 152, 53)
    call setplane(2, 111, 151, 53,   150, 152, 53)


! Bottom pattern ----
    call setplane(2, 110, 148, 47,   150, 149, 47)
    call setplane(2, 110, 149, 47,   151, 150, 47)
    call setplane(2, 110, 150, 47,   152, 151, 47)
    call setplane(2, 110, 151, 47,   153, 152, 47)
    call setplane(2, 150, 152, 47,   154, 153, 47)
    call setplane(2, 150, 153, 47,   154, 154, 47)
    call setplane(2, 150, 154, 47,   154, 155, 47)
    call setplane(2, 150, 155, 47,   154, 156, 47)
    call setplane(2, 150, 156, 47,   154, 157, 47)
    call setplane(2, 150, 157, 47,   154, 158, 47)
    call setplane(2, 150, 158, 47,   154, 159, 47)
    call setplane(2, 150, 159, 47,   154, 160, 47)
    call setplane(2, 150, 160, 47,   154, 161, 47)
    call setplane(2, 150, 161, 47,   154, 162, 47)
    call setplane(2, 150, 162, 47,   154, 163, 47)
    call setplane(2, 150, 163, 47,   154, 164, 47)
    call setplane(2, 150, 164, 47,   154, 165, 47)
    call setplane(2, 150, 165, 47,   154, 166, 47)
    call setplane(2, 150, 166, 47,   154, 167, 47)
    call setplane(2, 150, 167, 47,   154, 168, 47)
    call setplane(2, 150, 168, 47,   154, 169, 47)
    call setplane(2, 150, 169, 47,   154, 170, 47)
    call setplane(2, 150, 170, 47,   154, 171, 47)
    call setplane(2, 150, 171, 47,   154, 172, 47)
    call setplane(2, 150, 172, 47,   154, 173, 47)
    call setplane(2, 150, 173, 47,   154, 174, 47)
    call setplane(2, 150, 174, 47,   154, 175, 47)
    call setplane(2, 150, 175, 47,   154, 176, 47)
    call setplane(2, 150, 176, 47,   154, 177, 47)
    call setplane(2, 150, 177, 47,   154, 178, 47)
...
! Feed point ----
    call setplane(2, 110, 148, 53,   110, 152, 52)
    call setplane(2, 110, 148, 52,   110, 152, 51)
    call setplane(2, 110, 149, 51,   110, 151, 50)
    call setplane(2, 110, 149, 50,   110, 151, 49)
    call setplane(2, 110, 149, 49,   110, 151, 48)
    call setfeed(1, 110, 150, 47,   110, 150, 48, 100.0d0, 1, 800.0d0 * dt, 1.0d0)
